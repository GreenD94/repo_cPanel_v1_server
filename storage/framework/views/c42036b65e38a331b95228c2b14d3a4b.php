                            ...
                            <div class="pricing-plan-card card mx-lg-2 h-100">
                                <div class="card-body p-0 text-center">
                                    ...
                                    <div class="d-flex justify-content-center pb-4 pricing-text">
                                        ...
                                        <p class="pt-xl-3 pt-lg-2 pt-1 mb-0 ms-1 <?php echo e(App::getLocale() == 'ar' ? 'me-1' : 'ms-1'); ?>">
                                            /<?php if( \App\Models\SubscriptionPlan::PLAN_TYPE[$subscriptionsPricingPlan->frequency] == "Month"): ?>
                                            <?php echo e(__('messages.month')); ?>

                                            <?php else: ?>
                                            <?php echo e(__('messages.subscription.year')); ?>

                                            <?php endif; ?></p>
                                    </div>
                                    <ul class="pricing-plan-features px-2 pt-4 mt-2 <?php echo e(App::getLocale() == 'ar' ? 'text-end' : 'text-start'); ?>">
                                        <?php if(getLoggedInUser() != null && count($subscriptionsPricingPlan->subscription) > 0): ?>
                                            ...
                                            <?php if($activeSubscription && isAuth() &&  $activeSubscription->subscriptionPlan->id == $subscriptionsPricingPlan->id): ?>
                                                <li class="active-check pb-3 <?php echo e(App::getLocale() == 'ar' ? 'text-end' : 'text-start'); ?>">
                            ...
                            <div class="pricing-plan-card card mx-lg-2 h-100">
                                <div class="card-body p-0 text-center">
                                    ...
                                    <div class="d-flex justify-content-center pb-4 pricing-text">
                                        <h2 class="text-cyan mb-0">
                                            <?php echo e(getAdminCurrencySymbol($subscriptionsPricingPlan->currency)); ?></span><?php echo e(number_format($subscriptionsPricingPlan->price, 2)); ?></h2>
                                        <p class="pt-xl-3 pt-lg-2 pt-1 mb-0  <?php echo e(App::getLocale() == 'ar' ? 'me-1' : 'ms-1'); ?>">
                                            /<?php if( \App\Models\SubscriptionPlan::PLAN_TYPE[$subscriptionsPricingPlan->frequency] == "Month"): ?>
                                            <?php echo e(__('messages.month')); ?>
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/landing/home/pricing_plan_page.blade.php ENDPATH**/ ?>