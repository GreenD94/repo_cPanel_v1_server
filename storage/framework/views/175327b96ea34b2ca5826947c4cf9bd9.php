...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row align-items-center flex-column-reverse flex-lg-row">
                    <div class="col-lg-6 text-lg-start text-center">
                        <div class="banner-content mt-lg-0 mt-sm-5 mt-4 pe-lg-4">
                            <h1 class="mb-md-3 mb-2 <?php echo e(App::getLocale() == 'ar' ? 'text-lg-end' : ''); ?>"> <?php echo e($sectionOne['text_main']); ?> </h1>
                            <?php if(!getLoggedInUser()): ?>
                                <p class="mb-md-5 mb-4 <?php echo e(App::getLocale() == 'ar' ? 'text-lg-end' : ''); ?>"> <?php echo e($sectionOne['text_secondary']); ?></p>
                            <?php endif; ?>
                            <div class="d-flex align-items-center justify-content-center justify-content-lg-start">
                                <?php if(!getLoggedInUser()): ?>
                                    <a href="<?php echo e(route('filament.auth.auth.login')); ?>" data-turbo="false"
                                       class="btn btn-primary <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"><?php echo e(__('messages.web_home.sign_up')); ?></a>
                                <?php endif; ?>
                                <a href="<?php echo e(route('landing.contact.us')); ?>"
                                   class="btn btn-secondary ms-1"><?php echo e(__('messages.contact_us')); ?></a>
                            </div>
                            <span class="ps-xl-2 mb-3 mb-lg-0 d-lg-block mt-3 d-none <?php echo e(App::getLocale() == 'ar' ? 'float-end' : ''); ?>"><?php echo e(__('messages.landing.call')); ?> :
                    ...
                    <div class="col-12 margin-b-80px">
                        <div class="row align-items-center flex-column-reverse flex-lg-row">
                            ...
                            <div class="col-lg-6 position-relative">
                                <div class="sass-right-content  <?php echo e(App::getLocale() == 'ar' ? 'me-lg-5 pe-lg-5' : 'ms-lg-5 ps-lg-5'); ?>">
                                    ...
                                    <div class="sass-desc mb-4">
                                        <div class="row">
                                            <div class="col-sm-6 d-flex align-items-center mb-3 pb-1">
                                                <i class="fa-solid fa-check d-flex align-items-center justify-content-center text-white bg-primary <?php echo e(App::getLocale() == 'ar' ? 'ms-2' : 'me-2'); ?>"></i>
                                    ...
                                    <div class="sass-btn d-flex col-lg-12">
                                        <a href="<?php echo e(route('landing.contact.us')); ?>"
                                           class="btn btn-primary <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"><?php echo e(__('messages.contact_us')); ?></a>
                                        <?php if(!getLoggedInUser()): ?>
                                            <a href="<?php echo e(route('filament.auth.auth.login')); ?>" data-turbo="false"
    ...
    <?php echo $__env->make('landing.home.grow_hospital_section', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('landing.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/landing/home/index.blade.php ENDPATH**/ ?>