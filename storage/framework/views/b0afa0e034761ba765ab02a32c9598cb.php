...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('web_front/css/hospital-bootstrap.css')); ?>">
        ...
        <div class="row justify-content-md-center d-block">
            ...
            <div class="col-md-12 text-center error-page-404">
                ...
                <p class="not-found-subtitle">The page you are looking for doesn't exists / isn't available / was
                    loading
                    incorrectly.</p>
                <a class="btn btn-success back-btn mt-3" href="<?php echo e(url()->previous()); ?>">Back to Previous Page</a>
            </div>
        </div>
    </div>
</body>
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>