...
<?php $component->withAttributes([]); ?>
    <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Invoices')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.billings.resources.invoices.index')); ?>">
                <div
        ...
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Bills')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.billings.resources.bills.index')); ?>">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Payments')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.billings.resources.payments.index')); ?>">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
        ...
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Advance Payments')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.billings.resources.advanced-payments.index')); ?> ">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
                    ...
                    <div class="grid gap-y-2">
                        <div class="flex items-center gap-x-2">
                            <span
                                class="fi-wi-stats-overview-stat-label text-sm font-bold text-gray-500 dark:text-gray-400">
                                <?php echo e(__('messages.dashboard.total_advance_payments')); ?>

                            </span>
                        </div>
                        <div class="text-right text-2xl font-semibold tracking-tight text-gray-950 dark:text-white">
                            <?php echo e($advancePaymentAmount); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Doctors')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.doctors.resources.doctors.index')); ?>">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
                    ...
                    <div class="grid gap-y-2">
                        <div class="flex items-center gap-x-2">
                            <span
                                class="fi-wi-stats-overview-stat-label text-sm font-bold text-gray-500 dark:text-gray-400">
                                <?php echo e(__('messages.dashboard.doctors')); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Patients')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.patients.resources.patients.index')); ?>">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
                    ...
                    <div class="grid gap-y-2">
                        <div class="flex items-center gap-x-2">
                            <span
                                class="fi-wi-stats-overview-stat-label text-sm font-bold text-gray-500 dark:text-gray-400">
                                <?php echo e(__('messages.dashboard.patients')); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Nurses')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.users.resources.nurses.index')); ?>">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
        ...
        <!--[if BLOCK]><![endif]--><?php if(getModuleAccess('Beds')): ?>
            <a href="<?php echo e(route('filament.hospitalAdmin.bed-management.resources.beds.index')); ?>">
                <div
                    class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                    <div
                        class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
...
<?php endif; ?>
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/filament/hospital-admin/widgets/dashboard-state.blade.php ENDPATH**/ ?>