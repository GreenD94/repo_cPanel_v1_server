<div>
    <!--[if BLOCK]><![endif]--><?php if($getRecord()->is_default): ?>
        <span style="--c-50:var(--success-50);--c-400:var(--success-400);--c-600:var(--success-600);"
            ...
            <span class="grid"> <span class="truncate"> <?php echo e(__('messages.common.default_plan')); ?> </span> </span> </span>
    <?php else: ?>
        <div type="button" x-on:click="$wire.call('toggleStatus', <?php echo e($getRecord()->id); ?>)"
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/tables/columns/status-switcher.blade.php ENDPATH**/ ?>