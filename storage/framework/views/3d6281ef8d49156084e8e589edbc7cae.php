...
x-init="(() => {
    ...
    if (state) {
        let odontogram = JSON.parse(state);
        odontogram.forEach(item => {
    ...
    document.querySelectorAll('.clickUl a').forEach(el => {
    ...
    document.querySelectorAll('#Spots polygon, #Spots path').forEach(el => {
        el.addEventListener('click', () => {
            const key = el.getAttribute('data-key');
            if (!key) return;

            let odontogram = state ? JSON.parse(state) : [];
            const existing = odontogram.find(item => item.key === key);

            if (selectedColor) {
                if (existing && existing.color === selectedColor) {
                    odontogram = odontogram.filter(item => item.key !== key);
                    el.style.fill = '';
                } else {
                    el.style.fill = selectedColor;
                    odontogram = odontogram.filter(item => item.key !== key);
                    odontogram.push({ key: key, color: selectedColor });
                }
            } else if (existing) {
                odontogram = odontogram.filter(item => item.key !== key);
                el.style.fill = '';
            ...
            state = JSON.stringify(odontogram);
        });
    });
})()"
>
        <div class="form-group pt-4">
            <ul class="clickUl pt-4 mt-5 flex flex-wrap gap-x-3 gap-y-2 list-none p-0">
                <li>
                    <a data-color="#e91e63" id="1"
                        class="inline-block px-3 py-1 rounded text-white cursor-pointer select-none"
                        style="background:#e91e63; color:#fff;">
                        K
                    </a>
                </li>
                <li>
                    <a data-color="#3f51b5" id="2"
                        class="inline-block px-3 py-1 rounded text-whit cursor-pointer select-none"
                        style="background:#3f51b5; color:#fff;">
                        C
                    </a>
                </li>
                <li>
                    <a data-color="#009688" id="3"
                        class="inline-block px-3 py-1 rounded text-white cursor-pointer select-none"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.index','data' => ['type' => 'hidden','xModel' => 'state','wire:model.live' => 'odontogram','id' => 'odontogram']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'hidden','x-model' => 'state','wire:model.live' => 'odontogram','id' => 'odontogram']); ?>
...
<?php endif; ?>
            ...
            <div class="mb-3">
                <div>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" viewBox="0 0 450 700" enable-background="new 0 0 450 700" xml:space="preserve">
                        <g id="toothLabels">
                        ...
                        <g id="Spots" class="Spots">
                            <polygon id="Tooth32" fill="white" data-key="32"
                            ...
                            <polygon id="Tooth31" fill="white" data-key="31"
                ...
                46.7,476.7 37.7,446.3 39.7,438.3 43.3,432 49,426.7 56,424.7 65,424.7 	">
                            ...
                            <polygon id="Tooth30" fill="white" data-key="30"
        ...
        60.3,529.7 56.3,523.7 51.7,511 47.7,494.7 47.7,488.3 50.3,483.3 55,479.7 67,476.7 	">
                            ...
                            <polygon id="Tooth29" fill="white" data-key="29"
        ...
        98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	">
                            ...
                            <path id="Tooth28" fill="white" data-key="28" d="M117.3,569.7l7.7,1.3l6.3,3.7l6.3,7.7l4,8.3L144,602l-1.3,6.7l-6.7,6.7l-7.7,3.3l-7.3-1l-7-3
        l-7.3-7l-5-9l-2-10c0,0-0.7-7,0.3-7.3c1-0.3,5.3-6.7,5.3-6.7l9-5H117.3z"></path>
                            <polygon id="Tooth27" fill="white" data-key="27"
        ...
        133.3,641.3 128.7,634.7 128.7,629 132.7,621.3 137.7,615 143.7,611 149.7,610 	">
                            ...
                            <polygon id="Tooth26" fill="white" data-key="26"
        ...
        168,656.3 159.3,649.7 156.7,644 162,639.3 	">
                            ...
                            <polygon id="Tooth25" fill="white" data-key="25"
        ...
        190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	">
                            ...
                            <path id="Tooth24" fill="white" data-key="24" d="M235.3,637c0,0,3-2,4-2.3c1-0.3,4.3,0,4.3,0l5,4.3l5.3,7.3l3.3,6.7l2,7.3l-2,3l-7.7,2.7
        l-10,0.3h-10l-2-6.7l2.7-7.3L235.3,637z"></path>
                            <polygon id="Tooth23" fill="white" data-key="23"
        ...
        292,643.3 291.3,650 287,655 280.7,658.7 272,660 265,660.7 261.3,657.3 261.7,650 263.7,637 264.3,627 	">
                            ...
                            <polygon id="Tooth22" fill="white" data-key="22"
        ...
        321,630 321.3,620.3 317,614.3 308,608 298.3,607 291,609.3 287,612.3 286.7,617.7 287.3,624.7 	">
                            ...
                            <polygon id="Tooth21" fill="white" data-key="21"
        ...
        342.7,604 337.7,609 328,612.7 320,613.3 315,611 308.3,604.7 306.7,598 307.3,591.3 309,584.7 312.7,578.3 318.3,571.7 	">
                            ...
                            <polygon id="Tooth20" fill="white" data-key="20"
        ...
        381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	">
                            ...
                            <path id="Tooth19" fill="white" data-key="19" d="M398,470l4.7,5.7l3,7.7l-0.3,11.7l-6,13.3l-6.3,10.3l-8.3,4.3l-7.3-1l-16.3-7c0,0-2.7-6-3-7.3
        c-0.3-1.3-0.3-11-0.3-11l3.7-14.3l3.7-7l5.3-6.7l8-2l9.7-0.7L398,470z"></path>
                            <polygon id="Tooth18" fill="white" data-key="18"
        ...
        407.7,427.3 	">
                            ...
                            <polygon id="Tooth17" fill="white" data-key="17"
        ...
        406.7,395 401,377.7 397.3,373 390.7,367.3 380,365 373,366.7 367.3,369 364,374.3 360,389 363.3,401.3 367.7,412.3 	">
                            ...
                            <polygon id="Tooth16" fill="white" data-key="16"
        ...
        369,339.7 359,335 354.7,327.7 354.3,316 358.3,304 363.7,294 368.7,294.7 378.7,296 389,296 	">
                            ...
                            <polygon id="Tooth15" fill="white" data-key="15"
        ...
        371,294.3 392,295 404.3,293.7 410,280.7 412,263.3 407.3,246.7 401,240.3 396,239.7 389.3,243 	">
                            ...
                            <polygon id="Tooth14" fill="white" data-key="14"
        ...
        393,196 399.3,207 401.3,222.7 400,234.3 394.7,240.7 381.7,244.7 371,246 	">
                            ...
                            <polygon id="Tooth13" fill="white" data-key="13"
        ...
        383.3,178.3 	">
                            ...
                            <polygon id="Tooth12" fill="white" data-key="12"
        ...
        348.7,122.7 354.3,127.7 	">
                            ...
                            <polygon id="Tooth11" fill="white" data-key="11"
        ...
        297.3,120.3 294,112 295.7,102.7 299,95 303.3,90 309.3,88 316.3,87.3 322.7,87.3 328,88.3 	">
                            ...
                            <polygon id="Tooth10" fill="white" data-key="10"
        ...
        274.7,54.7 282,53 287.7,54.7 297.3,60.3 304,64.3 308.7,68.7 312.3,74 313,81 	">
                            ...
                            <polygon id="Tooth9" fill="white" data-key="9"
        ...
        222,58.3 219,50 220,44.3 224.3,40.3 230,38.7 237.3,38.7 253,39.3 258.7,41.3 264.3,43.7 268.3,45.7 	">
                            ...
                            <polygon id="Tooth8" fill="white" data-key="8"
        ...
        212.3,75.7 208,83 201.7,85.7 195.7,86.7 189.7,83.3 183.7,74.7 175,62 171.7,54 172.7,49.7 	">
                            ...
                            <path id="Tooth7" fill="white" data-key="7" d="M167,55l6.7,6.3L174,68l0.3,8l1,10l-2,8.3l-4.7,4.3l-6.7,1.7l-8-4.3l-7.3-4.7l-9.3-4.7
        l-6.3-5.3l-1-4.3l1.3-5c0,0,3.3-6,4.3-6s5.3-6,6.3-6s10.3-4.7,10.3-4.7L167,55z"></path>
                            <polygon id="Tooth6" fill="white" data-key="6"
        ...
        131.3,125 121,125 114.7,119.3 110.3,112.3 108.3,104.7 108.7,94.7 110.7,88.7 116,84 	">
                            ...
                            <polygon id="Tooth5" fill="white" data-key="5"
        ...
        105.7,162.3 96.7,161 85.7,156 82,150 81,139.3 86.3,128 93,121.3 100.7,117.3 	">
                            ...
                            <polygon id="Tooth4" fill="white" data-key="4"
        ...
        73.7,201 64.3,196.7 60.3,190.7 59,183.3 61.7,175.3 66.3,167.7 71.3,161.3 	">
                            ...
                            <path id="Tooth3" fill="white" data-key="3" d="M92.7,207.3l2,5.3l-1.7,8l-1.7,9l-4,8l-5,7.7l-11,4.7l-13.7,0.7l-10-7l-1.7-5L45,220l3-10.7
        l5-7.3l4-3.3l4.7-2.7l5.3,3.7l6.7,1.3c0,0,7.3,1.3,9.3,1.3s6.3,0.7,6.3,0.7L92.7,207.3z"></path>
                            <polygon id="Tooth2" fill="white" data-key="2"
        ...
        50.3,246.7 56,249 65.3,250.7 74,249.7 80.3,249.7 82.3,254 85.3,259.3 87,267.7 87.7,274.7 85.3,282.7 	">
                            ...
                            <polygon id="Tooth1" fill="white" data-key="1"
...
<?php endif; ?>
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/forms/components/odontogram-view.blade.php ENDPATH**/ ?>