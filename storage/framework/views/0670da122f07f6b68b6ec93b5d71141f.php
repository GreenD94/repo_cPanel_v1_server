...
<?php $component->withAttributes([]); ?>
    <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        <a href="<?php echo e(route('filament.superAdmin.resources.hospitals.index')); ?>">
            <div
        ...
        <a href="<?php echo e(route('filament.superAdmin.billings.resources.transactions.index')); ?>">
            <div
                class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                <div
                    class="flex items-center justify-center w-11 h-11  rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
                ...
                <div class="grid gap-y-2">
                    <div class="flex items-center gap-x-2">
                        <span
                            class="fi-wi-stats-overview-stat-label text-sm font-bold text-gray-500 dark:text-gray-400">
                            <?php echo e(__('messages.dashboard.total_revenue')); ?>
        ...
        <a href="<?php echo e(route('filament.superAdmin.billings.resources.subscriptions.index')); ?>">
            <div
                class="fi-wi-stats-overview-stat relative items-center rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 flex justify-between">
                <div
                    class="flex items-center justify-center w-11 h-11 rounded-lg p-1 ring-2 ring-inset ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400">
                ...
                <div class="grid gap-y-2">
                    <div class="flex items-center gap-x-2">
                        <span
                            class="fi-wi-stats-overview-stat-label text-sm font-bold text-gray-500 dark:text-gray-400">
                            <?php echo e(__('messages.dashboard.total_active_hospital_plan')); ?>

                        </span>
                    </div>
                    <div class="text-right text-2xl font-semibold tracking-tight text-gray-950 dark:text-white">
                        <?php echo e($totalActivePlan); ?>
                ...
                <div class="grid gap-y-2">
                    <div class="flex items-center gap-x-2">
                        <span fill="currentColor"
                            class="fi-wi-stats-overview-stat-label text-sm font-bold text-gray-500 dark:text-gray-400">
                            <?php echo e(__('messages.dashboard.total_expired_hospital_plan')); ?>

                        </span>
                    </div>
                    <div class="text-right text-2xl font-semibold tracking-tight text-gray-950 dark:text-white">
                        <?php echo e($totalExpiredPlan); ?>
...
<?php endif; ?>
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/filament/widgets/sadmin-dashboard-state.blade.php ENDPATH**/ ?>