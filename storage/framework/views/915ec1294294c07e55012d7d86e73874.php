                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="<?php echo new \Illuminate\Support\EncodedHtmlString(route('landing-home')); ?>">
                                <img src="<?php echo new \Illuminate\Support\EncodedHtmlString(getSuperAdminAppLogoUrl()); ?>" alt="<?php echo new \Illuminate\Support\EncodedHtmlString(getSuperAdminAppName()); ?>"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            <?php echo new \Illuminate\Support\EncodedHtmlString(__('messages.new_change.hello') . '!'); ?></p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <?php echo new \Illuminate\Support\EncodedHtmlString(__('messages.new_change.click_the_button_below_to_verify_your_email_address')); ?>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($url); ?>"
                                                                                ...
                                                                                <?php echo new \Illuminate\Support\EncodedHtmlString(__('messages.new_change.verify_email_address')); ?></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <?php echo new \Illuminate\Support\EncodedHtmlString(__('messages.new_change.if_you_did_not_create_an_account')); ?></p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <?php echo new \Illuminate\Support\EncodedHtmlString(__('messages.new_change.thanks_regards')); ?><br>
                                            <?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name')); ?></p>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        <?php echo new \Illuminate\Support\EncodedHtmlString(__('messages.new_change.trouble', [
                                                            'actionText' => Lang::get('messages.new_change.verify_email_address'),
                                                        ])); ?>

                                                        <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($url); ?>"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;"><?php echo new \Illuminate\Support\EncodedHtmlString($url); ?></a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> <?php echo new \Illuminate\Support\EncodedHtmlString(getSuperAdminAppName()); ?>. All rights reserved.
                                        </p>
                                    </td>
                                </tr>
                            </table>
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/emails/verify.blade.php ENDPATH**/ ?>