<div class="fi-dropdown-header flex w-full gap-2 p-1 text-sm fi-dropdown-header-color-gray fi-color-gray">
    <a href="<?php echo e(route('ltu.translation.index')); ?>" target="_blank"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-gray-400 fi-dropdown-list-item-icon dark:text-gray-500">
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/layout/translations.blade.php ENDPATH**/ ?>