...
<?php $__env->startSection('content'); ?>
    <div class="terms-service-page">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="<?php echo e(asset('web_front/images/page-banner/privacy-policy.png')); ?>" alt="Infy Care" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="terms-service-section p-t-120 p-b-120">
            <div class="container">
                <p>
                <?php echo $frontSetting['privacy_policy']; ?>
...
<?php echo $__env->make('web.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/web/home/privacy-policy.blade.php ENDPATH**/ ?>