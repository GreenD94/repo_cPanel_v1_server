                ...
                <nav class="navbar navbar-expand-lg navbar-light justify-content-end py-0">
                    <?php if(!empty(getLoggedInUser()) && getLoggedInUser()->hasRole('Admin')): ?>
                        <a class="btn btn-primary d-lg-none d-block me-3" data-turbo="false"
                           href="<?php echo e(route('filament.hospitalAdmin.pages.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a>
                    <?php elseif(!empty(getLoggedInUser()) && getLoggedInUser()->hasRole('Super Admin')): ?>
                        <a class="btn btn-primary d-lg-none d-block me-3" data-turbo="false"
                           href="<?php echo e(route('filament.superAdmin.pages.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a>
                    <?php else: ?>
                        <a class="btn btn-primary d-lg-none d-block me-3" data-turbo="false"
                           href="<?php echo e(route('filament.auth.auth.login')); ?>"><?php echo e(__('messages.web_menu.login')); ?></a>
                    <?php endif; ?>
                                                ...
                                                <li class="nav-item languageSelection" data-prefix-value="<?php echo e($key); ?>">
                                                    <a href="javascript:void(0)"
                                                       class="nav-link d-flex align-items-center">
                                                        <img class="<?php echo e(App::getLocale() == 'ar' ? 'ms-2 ' : 'me-2'); ?> country-flag" src="<?php echo e(asset($imageValue)); ?>">
                                                        <?php echo e($value); ?></a>
                                                </li>
                                            <?php endif; ?>
                        ...
                        <div class="text-lg-end d-flex align-items-center ms-lg-3">
                            <?php if(!empty(getLoggedInUser()) && getLoggedInUser()->hasRole('Admin')): ?>
                                <a class="btn btn-primary d-lg-block d-none" data-turbo="false"
                                   href="<?php echo e(route('filament.hospitalAdmin.pages.dashboard')); ?>"><?php echo e(__('messages.dashboard.dashboard')); ?></a>
                            <?php elseif(!empty(getLoggedInUser()) && getLoggedInUser()->hasRole('Super Admin')): ?>
                                <a class="btn btn-primary d-lg-block d-none" data-turbo="false"
                                   href="<?php echo e(route('filament.superAdmin.pages.dashboard')); ?>"><?php echo e(__('messages.dashboard.dashboard')); ?></a>
                            <?php else: ?>
                                <a class="btn btn-primary d-lg-block d-none" data-turbo="false"
                                   href="<?php echo e(route('filament.auth.auth.login')); ?>"><?php echo e(__('messages.web_menu.login')); ?></a>
                            <?php endif; ?>
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/landing/layouts/header.blade.php ENDPATH**/ ?>