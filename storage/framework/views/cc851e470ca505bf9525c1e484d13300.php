...
<?php $component->withAttributes(['x-data' => '{}','x-on:change' => 'window.location.href = $event.target.value']); ?>
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $navigation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navigationGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $options = (function ($args) {
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $navigationGroup->getItems(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navigationItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [$navigationItem, ...$navigationItem->getChildItems()]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navigationItemChild): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            <?php if($navigationItemChild->isActive()): echo 'selected'; endif; ?>
                            value="<?php echo e($navigationItemChild->getUrl()); ?>"
                        >
                            <!--[if BLOCK]><![endif]--><?php if($loop->index): ?>
                                &ensp;&ensp;
            ...
            <!--[if BLOCK]><![endif]--><?php if(filled($navigationGroupLabel = $navigationGroup->getLabel())): ?>
...
<?php endif; ?>
<?php /**PATH /home/vzaiylnbi7hv/public_html/vendor/filament/filament/src/../resources/views/components/page/sub-navigation/select.blade.php ENDPATH**/ ?>