...
<?php $__env->startSection('content'); ?>
    <div class="contact-page">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="<?php echo e(asset('web_front/images/page-banner/contact.png')); ?>" alt="Infy Care" class="img-fluid"
                            loading="lazy" />
                    </div>
                </div>
            </div>
                    ...
                    <div class="btn-group mt-4 mt-xl-5">
                        ...
                        <?php if($hospitalSettingValue['linkedIn_url']['value'] != '' && !empty($hospitalSettingValue['linkedIn_url']['value'])): ?>
                            <a href="<?php echo e($hospitalSettingValue['linkedIn_url']['value']); ?>" class="btn btn-primary fs-4"
                                target="_blank"
                                style="<?php echo e(App::getLocale() == 'ar'
        ...
        <section class="contact-form-section p-b-200">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact-form__input-block">
                                            ...
                                            <input type="hidden" name="prefix_code" id="prefix_code" class="prefix_code" value="">
                                            <span class="text-green d-none fw-400 fs-small mt-2 valid-msg">✓ &nbsp;
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact-form__input-block">
                                            <select name="type" class="contactUsGeneral" id="contactUsGeneral">
                                                ...
                                                <option value="3"><?php echo e(\App\Models\Enquiry::TYPE_RESIDENTIAL); ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="contact-form__input-block">
                                            <textarea name="message" id="message" rows="4" class="form-control form-textarea"
                                                placeholder="<?php echo e(__('messages.web_contact.type_your_message')); ?>" required
            ...
            <input type="hidden" name="utilsScript" value="<?php echo e(asset('assets/js/int-tel/js/utils.min.js')); ?>" class="utilsScript">
            <input type="hidden" name="enquiryURl" value="<?php echo e(route('send.enquiry', getUser()->username)); ?>" class="enquiryURl">

            <?php if(getSettingForReCaptcha($userName)): ?>
                <input type="hidden" name="isGoogleCaptchaEnabled" value="<?php echo e(getSettingForReCaptcha($userName)); ?>" class="isGoogleCaptchaEnabled">
            <?php endif; ?>
...
<?php echo $__env->make('web.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/web/home/contact_us.blade.php ENDPATH**/ ?>