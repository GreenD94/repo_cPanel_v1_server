        ...
        <section
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 text-center <?php echo e(App::getLocale() == 'ar' ? 'text-lg-end' : 'text-lg-start'); ?>">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-lg-start justify-content-center mb-lg-0 mb-5">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <?php echo e(__('messages.web_home.about_us')); ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="<?php echo e(asset('web_front/images/page-banner/about.png')); ?>" alt="Infy Care" class="img-fluid"
                            loading="lazy" />
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-stretch flex-column-reverse flex-lg-row">
                        ...
                        <div class="row h-100">
                            ...
                            <div class="col-lg-7 col-md-7 about-count-block">
                                <div
                                    ...
                                    <div>
                                        <h3 class="text-blue">
                                            <?php echo e(getFrontSettingValue(\App\Models\FrontSetting::HOME_PAGE, 'home_page_experience')); ?>
                    ...
                    <div class="col-lg-6">
                        <div class="about-right pb-5 pt-lg-5 text-lg-start text-center">
                            <h2 class="mt-md-3"><?php echo e(\Illuminate\Support\Str::limit($frontSetting['about_us_title'], 50)); ?>

                            </h2>
                            <p class="mt-4"><?php echo \Illuminate\Support\Str::limit($frontSetting['about_us_description'], 615); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="col-lg-6 text-center mx-auto">
                    ...
                    <h2 class="mb-5 pb-xl-3">
                        <?php echo e(__('messages.web_home.we_are_experienced_healthcare_professionals')); ?>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6 text-center doctors-block my-lg-1">
                            <div class="px-lg-2 py-3">
                                <a href="<?php echo e(route('doctor.details', [$userName, $doctor->id])); ?>">
                                    <img src="<?php echo e($doctor->user->image_url); ?>" alt="Doctor" class="mx-auto card-image"
                                        loading="lazy">
                                    <div class="card text-center p-3">
                                        <h4><?php echo e(\Illuminate\Support\Str::limit($doctor->user->full_name, 23)); ?></h4>
                                        <p class="mb-2">
                                            (<?php echo e(\Illuminate\Support\Str::limit($doctor->user->qualification, 25)); ?>)</p>
...
<?php echo $__env->make('web.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/web/home/about_us.blade.php ENDPATH**/ ?>