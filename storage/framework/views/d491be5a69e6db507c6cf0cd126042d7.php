            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="<?php echo e(asset('web_front/images/page-banner/services.png')); ?>" alt="Infy Care"
                                ...
                                <div class="card p-c-4 my-lg-2 mx-lg-1 my-md-3 my-2 flex-fill">
                                    ...
                                    <div class="card-body p-0 text-center d-flex flex-column">
                                        <h4 class="card-title mt-4">
                                            <?php echo e(\Illuminate\Support\Str::limit($frontService->name, 16)); ?></h4>
                                        <p class="card-text">
...
<?php echo $__env->make('web.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/web/home/services.blade.php ENDPATH**/ ?>