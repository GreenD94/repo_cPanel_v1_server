            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="footer-info">
                    <div class="d-flex align-items-center footer-info__block mb-3">
                        <i class="fa-solid fa-location-dot text-primary <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i>
                    ...
                    <div class="d-flex align-items-center footer-info__block mb-3">
                        <i class="fa-solid fa-at text-primary <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i>
                    ...
                    <div class="d-flex align-items-center footer-info__block mb-3">
                        <i class="fa-solid fa-phone text-primary <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i>
                    ...
                    <div class="social-icon d-flex mt-lg-4">
                        <?php if(!empty($settingValue['facebook_url']['value'])): ?>
                            <a href="<?php echo e($settingValue['facebook_url']['value']); ?>" target="_blank"><i
                                        class="fa-brands fa-facebook-f d-flex align-items-center justify-content-center text-white <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($settingValue['instagram_url']['value'])): ?>
                            <a href="<?php echo e($settingValue['instagram_url']['value']); ?>" target="_blank"><i
                                        class="fa-brands fa-instagram d-flex align-items-center justify-content-center text-white <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($settingValue['twitter_url']['value'])): ?>
                            <a href="<?php echo e($settingValue['twitter_url']['value']); ?>" target="_blank"><i
                                        class="fa-brands fa-twitter d-flex align-items-center justify-content-center text-white <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($settingValue['linkedin_url']['value'])): ?>
                            <a href="<?php echo e($settingValue['linkedin_url']['value']); ?>" target="_blank"><i
                                        class="fa-brands fa-linkedin-in d-flex align-items-center justify-content-center text-white <?php echo e(App::getLocale() == 'ar' ? 'ms-3' : 'me-3'); ?>"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/vzaiylnbi7hv/public_html/resources/views/landing/layouts/footer.blade.php ENDPATH**/ ?>